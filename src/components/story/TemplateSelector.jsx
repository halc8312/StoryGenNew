...
const TemplateSelector = ({ selectedTemplate, setSelectedTemplate }) => {
  ...
  const handleTemplateChange = (e) => {
    ...
    if (value === 'custom') {
      ...
      setSelectedTemplate({ theme: customTheme, setting: customSetting });
    } else {
  ...
  const handleCustomThemeChange = (e) => {
    ...
    setSelectedTemplate({ theme: value, setting: customSetting });
  };

  const handleCustomSettingChange = (e) => {
    const value = e.target.value;
    setCustomSetting(value);
    setSelectedTemplate({ theme: customTheme, setting: value });
  };
